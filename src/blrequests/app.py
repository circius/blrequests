...
def table_get_headers(table: Tag) -> List[str]:
    """consumes a beautifulsoup representation of the table of requests
generated by myrequests.bl.uk and produces a list of its headers """
    header_tags = table.select("th>a")
    headers = [header_tag.next for header_tag in header_tags]
    return headers
